#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/Users/lv/.vscode/extensions/wallabyjs.console-ninja-1.0.371/out/buildHook/index.js').default({tool: 'astro', checkSum: '2068350ddbfdcde08bc407AhYCAx5TXlNeAVtVVlZeBgZXBA5U', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/lv/.vscode/extensions/wallabyjs.console-ninja-1.0.371/out/buildHook/index.js').then(m => m.default.default({tool: 'astro', checkSum: '2068350ddbfdcde08bc407AhYCAx5TXlNeAVtVVlZeBgZXBA5U', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
