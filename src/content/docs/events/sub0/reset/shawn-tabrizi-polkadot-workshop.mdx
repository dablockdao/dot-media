...
- **PAPI**: A newer, light-client-first library that simplifies cross-chain interaction.
...
2. **Bounties**: Platforms like **BuildOn.DOT** and the **Polkadot Bounties Repo** list project ideas and open issues funded by the Polkadot Treasury.
